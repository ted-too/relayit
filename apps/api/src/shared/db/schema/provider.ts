// Credentials shape lives in the channel leaf (not a DB enum). Import the leaf
// rather than a channels barrel that could pull `@repo/api/db` and cycle.
...
export const provider = pgTable(
  "provider",
  {
    ...
    name: text("name"),
    credentials: jsonb("credentials").$type<ChannelCredentials>().notNull(),
