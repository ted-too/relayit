...
import { formatEmailIdentity } from "@repo/api/worker/lib/email-utils";
import { categorizeAWSError } from "@repo/api/worker/providers/aws/errors";
import { PROVIDER_ERRORS } from "@repo/api/worker/providers/errors";
import type { SendMethod } from "@repo/api/worker/providers/interface";
import {
  channelIdentifierValidators,
  PROVIDER_CONFIG,
} from "@repo/shared/providers";

export interface SESResultDetails {
  messageId: string;
  requestId: string;
}
