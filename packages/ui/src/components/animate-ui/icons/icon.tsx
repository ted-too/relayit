...
import {
  Slot,
  type WithAsChild,
} from "@repo/ui/components/animate-ui/primitives/animate/slot";
...
// TODO: Fix this.
// biome-ignore lint/suspicious/noExplicitAny: this is intentional as per Animate UI docs.
...
function AnimateIcon({
  ...
  React.useEffect(() => {
    ...
    // biome-ignore lint/complexity/noVoid: this is intentional as per Animate UI docs.
    void run();
...
>(animations: V): T {
  // biome-ignore lint/correctness/useHookAtTopLevel: this is intentional as per Animate UI docs.
