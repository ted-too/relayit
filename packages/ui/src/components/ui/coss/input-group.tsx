...
import { Input, type InputProps } from "@repo/ui/components/ui/coss/input";
import {
  Textarea,
  type TextareaProps,
} from "@repo/ui/components/ui/coss/textarea";
...
export function InputGroup({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: this is intentional as per Coss UI docs.
    <div
      className={cn(
...
export function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: this is intentional as per Coss UI docs.
    // biome-ignore lint/a11y/noStaticElementInteractions: this is intentional as per Coss UI docs.
    <div
