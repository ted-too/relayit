...
function SidebarProvider({
  ...
  useHotkeys(SIDEBAR_KEYBOARD_SHORTCUT, () => toggleSidebar());
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "relative flex w-full min-w-0 flex-col overflow-x-hidden p-2",
        className
      )}
      data-sidebar="group"
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        align="center"
        hidden={isAvailable ? state !== "collapsed" || isMobile : false}
        side="right"
        {...tooltip}
      />
    </Tooltip>
